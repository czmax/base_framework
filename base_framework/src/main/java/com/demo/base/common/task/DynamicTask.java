...
public class DynamicTask {
    ...
    public String startCron() {
        ...
        future = threadPoolTaskScheduler.schedule(new TestTask3(), new CronTrigger("0/5 * * * * *"));
    ...
    public String startCron10() {
        ...
        future = threadPoolTaskScheduler.schedule(new TestTask3(), new CronTrigger("0/10 * * * * *"));
